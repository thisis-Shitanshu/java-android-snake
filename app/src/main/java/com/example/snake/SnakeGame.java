...
class SnakeGame extends SurfaceView implements Runnable{
    ...
    // This size in segments of the playable area
    ...
    public void newGame() {
        ...
        // Get thr apple ready for dinner
        mApple.spawn();
    ...
    public boolean updateRequired() {
        ...
        if (mNextFrameTime <= System.currentTimeMillis()) {
            ...
            // Return true so that the update and draw method are executed
            return true;
        }
        ...
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_UP:
                if (mPaused) {
                    ...
                    // Don't want to process snake directoin for this tap
                    return true;
                }
